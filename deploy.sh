...
SECRET_KEY="i-dont-know"                 # for the demo app
...
echo "GITHUB_OAUTH_TOKEN=dummy" >>"$APP_DIR/.env"

echo "RESEND_API_KEY=dummy" >>"$APP_DIR/.env"
echo "EMAIL_FROM='SaaS Starter App <onboarding@resend.dev>'" >>"$APP_DIR/.env"
echo "STRIPE_API_KEY=dummy" >>"$APP_DIR/.env"
echo "STRIPE_WEBHOOK_SECRET=dummy" >>"$APP_DIR/.env"
echo "NEXT_PUBLIC_STRIPE_PRO_MONTHLY_PLAN_ID=dummy" >>"$APP_DIR/.env"
echo "NEXT_PUBLIC_STRIPE_PRO_YEARLY_PLAN_ID=dummy" >>"$APP_DIR/.env"
echo "NEXT_PUBLIC_STRIPE_BUSINESS_MONTHLY_PLAN_ID=dummy" >>"$APP_DIR/.env"
echo "NEXT_PUBLIC_STRIPE_BUSINESS_YEARLY_PLAN_ID=dummy" >>"$APP_DIR/.env"
echo "NEXT_TELEMETRY_DISABLED=1" >>"$APP_DIR/.env"
echo "AUTH_TRUST_HOST=http://$DOMAIN_NAME" >>"$APP_DIR/.env"
echo "DATABASE_URL=$DATABASE_URL" >>"$APP_DIR/.env"
echo "DIRECT_URL=$DATABASE_URL" >>"$APP_DIR/.env"
